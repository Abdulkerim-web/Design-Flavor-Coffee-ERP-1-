...
const Swatch: FC<{
  ...
  textColor?: string
  border?: boolean
}> = ({ label, token, value, textColor = "var(--text-primary)", border }) => (
...
const SwatchGroup: FC<{ title: string children: ReactNode }> = ({
  title,
  children,
}) => (
...
const TokenRow: FC<{ token: string value: string demo?: ReactNode }> = ({
  token,
  value,
  demo,
}) => (
...
const I: FC<{ d: string color?: string size?: number }> = ({
  d,
  color = "currentColor",
  size = 16,
}) => (
  ...
  const DEMO_TIMELINE: TimelineItem[] = [
    {
      ...
      title: "Order Created",
      actor: "Kebede Alemu",
      timestamp: "Aug 12, 2026 · 09:14",
      description: "Customer order received and confirmed.",
    },
    {
      id: 2,
      status: "completed",
      ...
      actor: "System",
      timestamp: "Aug 12, 2026 · 09:15",
      description: "Yirgacheffe Grade 1 · 80 KG reserved from lot GR-0312.",
      quantity: "80 KG",
    },
    {
      id: 3,
      status: "completed",
      title: "Roasting Started",
      actor: "Tadesse Worku",
      timestamp: "Aug 12, 2026 · 11:00",
      description: "Batch #BR-042 · 30 KG input.",
    },
    {
      id: 4,
      status: "in-progress",
      ...
      actor: "Tadesse Worku",
      timestamp: "Aug 12, 2026 · 13:20",
      description: "Target roast profile: Medium. Est. completion 15:00.",
    },
    {
      id: 5,
      status: "pending",
      title: "Packing & QC Pending",
      actor: undefined,
      timestamp: "Scheduled · Aug 13",
      description: "Awaiting roast completion before packing begins.",
    },
    {
      id: 6,
      status: "warning",
      title: "Partial Delivery Flagged",
      actor: "Yonas Haile",
      timestamp: "Aug 10, 2026 · 16:45",
      description: "5 KG short on delivery — customer accepted with note.",
      flagged: true,
    },
  ]
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Single source of truth for all visual tokens, component states, and
          design conventions used across the Coffee-Roasting ERP.
        </p>
          ...
          {(["light", "dark", "system"] as ThemeMode[]).map((m) => (
            <button
              ...
              style={{
                ...
                borderRadius: 999,
                border: `1.5px solid ${
                  mode === m ? "var(--brand-primary)" : "var(--border-neutral)"
                }`,
                background:
                  mode === m ? "var(--brand-primary)" : "var(--surface-01)",
      ...
      <Section id="colors" title="Color System">
        <SwatchGroup title="Surfaces">
          ...
          <Swatch
            ...
            value="var(--surface-01)"
            border
          />
          <Swatch
            label="Sunken"
            token="--color-surface-sunken"
            value="var(--surface-02)"
            border
          />
          <Swatch
            label="Hover"
        ...
        <SwatchGroup title="Brand">
          <Swatch
            label="Espresso"
            token="--color-brand-espresso"
            value={isDark ? "#1A2E22" : "#1A2E22"}
          />
          <Swatch
            label="Roast (Primary)"
            token="--color-brand-roast"
            value={isDark ? "#34D399" : "#2B4D3A"}
          />
          <Swatch
            label="Accent Gold"
            token="--accent-gold"
            value={isDark ? "#D97706" : "#B8860B"}
          />
        ...
        <SwatchGroup title="Status Surfaces">
          {[
            {
              label: "Safe surface",
              v: isDark ? "rgba(34,197,94,0.1)" : "#F0FDF4",
            },
            {
              label: "Warning surface",
              v: isDark ? "rgba(251,191,36,0.1)" : "#FFFBEB",
            },
            {
              label: "Danger surface",
              v: isDark ? "rgba(248,113,113,0.1)" : "#FEF2F2",
            },
            {
              label: "Info surface",
              v: isDark ? "rgba(96,165,250,0.1)" : "#EFF6FF",
            },
          ].map((s) => (
            <Swatch
              key={s.label}
              label={s.label}
              token="--color-status-*-surface"
              value={s.v}
              border
            />
          ))}
        ...
        <SwatchGroup title="Borders">
          <Swatch
            ...
            value="rgba(229,227,220,0.5)"
            border
          />
          <Swatch
            label="Default"
            token="--color-border-default"
            value="var(--border-neutral)"
            border
          />
          <Swatch
            label="Strong"
            token="--color-border-strong"
            value={isDark ? "#363A42" : "#C9C7BF"}
            border
          />
          <Swatch
            label="Focus"
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
          {[
            ...
            { cls: "type-h3", label: "H3", sample: "Green Bean Stock" },
            {
              cls: "type-body-large",
              label: "Body Large",
              sample: "Review the latest roasting batch and confirm quality.",
            },
            {
              cls: "type-body",
              label: "Body",
              sample: "Customer order status updated to Confirmed.",
            },
            {
              cls: "type-body-medium",
              label: "Body Medium",
              sample: "Feasibility — Ready to fulfil",
            },
            {
              cls: "type-caption",
              label: "Caption",
            ...
            },
            {
              cls: "type-micro",
              label: "Micro / Code",
              sample: "ORD-1042 · CUS-0001 · RB-2887",
            },
            { cls: "type-numeric", label: "Numeric", sample: "ETB 487,235.00" },
            {
              cls: "type-numeric-lg",
              label: "Numeric Large",
              sample: "ETB 1,243,780.00",
            },
          ].map((row) => (
            <div
              key={row.cls}
        ...
        <div style={{ marginTop: 28 }}>
          ...
          >
            {[
              ...
              {
                name: "DM Mono",
                role: "Numeric / Code / References",
                sample: "ETB 487,235.00 · ORD-1042",
                style: { fontFamily: "DM Mono" },
              },
              {
                name: "Fraunces",
                role: "Display / Brand moments",
                sample: "Flavor Coffee Roasters",
          ...
          {[
            {
              token: "--space-1",
              px: "4px",
              use: "Icon gap, metadata separation",
            },
            {
              token: "--space-2",
              px: "8px",
              use: "Badge padding, tight controls",
            },
            ...
            { token: "--space-4", px: "16px", use: "Card padding, field rows" },
            {
              token: "--space-6",
              px: "24px",
              use: "Section padding, card content",
            },
            ...
            { token: "--space-12", px: "48px", use: "Dashboard section gaps" },
            {
              token: "--space-16",
              px: "64px",
              use: "Empty-state centering, page gutters",
            },
            {
              token: "--space-20",
              px: "80px",
              use: "Hero areas, major visual separation",
            },
          ].map((r) => (
            <div
              key={r.token}
          ...
          {[
            {
              token: "--radius-sm",
              px: "4px",
              use: "Inputs, badges, tiny controls",
            },
            {
              token: "--radius-md",
              px: "8px",
              use: "Buttons, tags, compact cards",
            },
            ...
            { token: "--radius-xl", px: "16px", use: "Modals, major surfaces" },
            {
              token: "--radius-pill",
              px: "999px",
              use: "Status badges, pill selectors",
            },
          ].map((r) => (
            <div
              key={r.token}
        ...
        >
          {[
            ...
            },
            {
              ...
              token: "--shadow-modal",
              use: "Modals, drawers",
              boxShadow: "0px 25px 50px -12px rgba(0,0,0,0.18)",
            },
          ].map((s) => (
            <div
              key={s.label}
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
          {[
            { token: "--z-base", value: "0", use: "Normal page content" },
            {
              token: "--z-raised",
              value: "10",
              use: "Sticky table headers, pinned columns",
            },
            {
              token: "--z-sticky",
              value: "100",
              use: "Sticky nav bar / top bar",
            },
            {
              token: "--z-dropdown",
              value: "200",
              use: "Select menus, autocomplete lists",
            },
            {
              token: "--z-popover",
              value: "300",
              use: "Tooltips, floating detail panels",
            },
            {
              token: "--z-drawer",
              value: "400",
              use: "Side drawers, filter panels",
            },
            {
            ...
            },
            {
              token: "--z-modal",
              value: "600",
              use: "Modal dialogs, confirm dialogs",
            },
            {
              token: "--z-toast",
              value: "700",
            ...
            { token: "--z-command", value: "800", use: "Command palette (⌘K)" },
            {
              token: "--z-critical",
              value: "900",
              use: "System-level critical overlays",
            },
          ].map((r) => (
            <TokenRow
              key={r.token}
      ...
      <Section id="transitions" title="Transition Tokens">
          ...
          {[
            {
              token: "--dur-fast",
              value: "100ms",
              use: "Micro-interactions (hover bg change)",
            },
            {
              token: "--dur-base",
              value: "200ms",
              use: "Standard state transitions",
            },
            {
              token: "--dur-slow",
              value: "300ms",
              use: "Page enters, drawer slides",
            },
            {
              token: "--ease-apple",
              value: "cubic-bezier(0.16, 1, 0.3, 1)",
              use: "All ERP animations",
            },
            {
              token: "--transition-fast",
              value: "all 100ms ease-apple",
              use: "Fast interactive elements",
            },
            {
              token: "--transition-base",
              value: "all 200ms ease-apple",
              use: "Standard interactive elements",
            },
            {
              token: "--transition-color",
        ...
        >
          <strong>Reduced motion:</strong> All transitions collapse to 0.01ms
          when{" "}
          <code style={{ fontFamily: "DM Mono", fontSize: 12 }}>
            prefers-reduced-motion: reduce
          </code>{" "}
          is active. This is enforced globally in{" "}
          <code style={{ fontFamily: "DM Mono", fontSize: 12 }}>index.css</code>
          .
        </div>
      </Section>
        ...
        <div style={{ marginBottom: 32 }}>
          ...
          >
            ...
            <div>
              ...
              <input
                className={`input-field${inputErr ? " error" : ""}`}
                style={{ width: "100%" }}
                placeholder="Invalid input"
                value="wrong value"
                onChange={() => {}}
                onFocus={() => setInputErr(true)}
                onBlur={() => setInputErr(false)}
              />
              {inputErr && (
                <div className="field-error-msg">This field is required.</div>
              )}
            </div>
            <div>
              <div
            ...
            <div>
              ...
              <input
                className="input-field"
                style={{ width: "100%", background: "var(--surface-02)" }}
                readOnly
              ...
              <div style={{ position: "relative", width: 16, height: 16 }}>
                ...
                <div
                  style={{
                    ...
                    borderRadius: 4,
                    border: `2px solid ${
                      checked ? "var(--brand-primary)" : "var(--border-neutral)"
                    }`,
                    background: checked
                      ? "var(--brand-primary)"
                      : "var(--surface-01)",
        ...
        <div style={{ marginBottom: 32 }}>
          ...
          <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
            {[
              ...
              <span key={b.cls} className={b.cls}>
                {b.label}
              </span>
            ))}
          </div>
          ...
          >
            {[
              ...
              <div key={c.label} className="stat-card">
                ...
                <span className={c.up ? "delta-up" : "delta-down"}>
                  {c.delta}
                </span>
              </div>
            ))}
            ...
            {[
              {
                type: "safe",
                title: "Safe",
                msg: "Stock is sufficient for all pending orders.",
                bg: "var(--color-status-safe-surface)",
                border: "var(--color-status-safe-border)",
                color: "var(--color-status-safe)",
                icon: STATUS_ICONS.safe,
              },
              {
                type: "warning",
                title: "Warning",
                msg: "Sidama green stock is approaching the reorder threshold.",
              ...
              },
              {
                type: "danger",
                title: "Danger",
                msg: "Insufficient stock for ORD-1042. Manager override required.",
              ...
              },
              {
                type: "info",
                title: "Info",
                msg: "Order ORD-1041 is currently in the roasting stage.",
      ...
      <Section id="status" title="Status System">
        ...
        >
          Every status indicator must use <strong>color + icon + text</strong>.
          ...
          {[
            {
              ...
              border: "var(--color-status-safe-border)",
              icon: STATUS_ICONS.safe,
              use: "Paid · Verified · Adequate stock · Completed",
            },
            {
              label: "Warning",
              color: "var(--color-status-warning)",
              ...
              border: "var(--color-status-warning-border)",
              icon: STATUS_ICONS.warning,
              use: "Low stock · Approaching deadline · Discrepancy",
            },
            {
              label: "Danger",
              color: "var(--color-status-danger)",
              ...
              border: "var(--color-status-danger-border)",
              icon: STATUS_ICONS.danger,
              use: "Insufficient stock · Overdue · Rejected · Error",
            },
            {
              label: "Info",
              color: "var(--color-status-info)",
              ...
              border: "var(--color-status-info-border)",
              icon: STATUS_ICONS.info,
              use: "Progress · Informational · Neutral events",
            },
            {
              label: "Pending",
              ...
              use: "Awaiting approval · Not yet started",
            },
            {
              label: "Processing",
              color: "var(--sem-info)",
              ...
              use: "Roasting · Packing · In transit",
            },
          ].map((s) => (
            <div
              key={s.label}
      ...
      <Section id="icons" title="Icon Vocabulary">
        ...
        >
          All icons use the same stroke weight (1.75px) and grid (24×24).
          Lucide-style inline SVG only — no external icon library.
        </div>
        <div
          style={{
            display: "grid",
        ...
        >
          {[
            ...
            {
              name: "flame (roasting)",
              d: "M8.5 14.5A2.5 2.5 0 0011 12c0-1.38-.5-2-1-3-1.072-2.143-.224-4.054 2-6 .5 2.5 2 4.9 4 6.5 2 1.6 3 3.5 3 5.5a7 7 0 11-14 0",
            },
            {
      ...
      <Section id="responsive" title="Responsive Grid System">
        ...
        >
          Resize the window to see the grid adapt. Mobile collapses to
          single-column; tablet uses 2-col; desktop uses full grid.
        </div>
        {[
          {
            label: ".resp-grid-4 — Dashboard KPI row (4 → 2 → 1 col)",
            cells: 4,
          },
          {
            label: ".resp-grid-3 — Inventory overview (3 → 2 → 1 col)",
            cells: 3,
          },
        ...
        <div style={{ marginBottom: 20 }}>
          ...
          >
            .resp-split — sidebar detail layout (row → column on mobile)
          </div>
            ...
            <tbody>
              {[
                ...
                },
                {
                  ...
                  status: "Roasting",
                  statusCls: "badge-gold",
                  date: "Aug 12, 2026",
                },
                {
                  ref: "ORD-1040",
                  customer: "Hilton Addis Ababa",
                  qty: "60 KG",
                ...
                <tr key={row.ref}>
                  ...
                  <td>{row.customer}</td>
                  <td>
                    <span style={{ fontFamily: "DM Mono" }}>{row.qty}</span>
                  </td>
                  ...
                  <td>
                    <span className={`badge ${row.statusCls}`}>
                      {row.status}
                    </span>
                  </td>
      ...
      <Section id="contrast" title="WCAG 2.1 AA Contrast Audit">
        ...
        >
          {[
            {
              pair: "text-primary on bg-primary (light)",
              ratio: "14.5:1",
              pass: true,
              note: "Inter body text — exceeds AAA",
            },
            {
              pair: "text-secondary on bg-primary (light)",
              ratio: "5.5:1",
              pass: true,
              note: "Secondary labels — passes AA",
            },
            {
              pair: "text-muted on bg-primary (light)",
              ratio: "2.5:1",
              pass: false,
              note: "Decorative / placeholder only — not used for required body copy",
            },
            {
              pair: "brand-primary on white (light)",
              ratio: "7.9:1",
              pass: true,
              note: "Button text on bg-primary — passes AAA",
            },
            {
              pair: "badge-amber text #B45309 on #FEF3C7",
              ratio: "6.1:1",
              pass: true,
              note: "Warning badge — passes AA",
            },
            {
              pair: "badge-red text #B91C1C on #FEE2E2",
              ratio: "5.1:1",
              pass: true,
              note: "Danger badge — passes AA",
            },
            {
              pair: "text-primary on bg-primary (dark)",
              ratio: "18.6:1",
              pass: true,
              note: "Dark mode body — exceeds AAA",
            },
            {
              pair: "text-secondary on bg-primary (dark)",
              ratio: "8.1:1",
              pass: true,
              note: "Dark secondary — passes AAA",
            },
            {
              pair: "text-muted on bg-primary (dark)",
              ratio: "4.0:1",
              pass: true,
              note: "Dark muted — passes AA normal text",
            },
            {
              pair: "focus ring #2B4D3A on bg-primary",
              ratio: "7.9:1",
              pass: true,
              note: "Focus indicator — sufficient contrast",
            },
          ].map((r) => (
            <div
              key={r.pair}
        ...
        >
          <strong>Note on --text-muted:</strong> This token is intentionally
          below AA (2.5:1 in light mode) and is restricted to decorative text,
          placeholder attributes, and table eyebrows where WCAG exempts from
          contrast requirements. It must never be used for required body copy or
          actionable labels.
        </div>
      </Section>
      ...
      <Section id="component-gallery" title="F3-04 · Component Gallery">
        ...
        >
          Shared components consumed by every ERP module. Each renders only
          backend-supplied data; no business logic is calculated inside
          components.
        </p>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
            <div>
              ...
              <TabPanel id="overview" active={activeTab}>
                ...
                >
                  Overview panel content — renders only when "Overview" tab is
                  active.
                </div>
              </TabPanel>
              <TabPanel id="orders" active={activeTab}>
                ...
                >
                  Orders panel — 14 active orders shown here.
                </div>
              </TabPanel>
              <TabPanel id="payments" active={activeTab}>
                ...
                >
                  Payments panel — 3 pending payments.
                </div>
              </TabPanel>
        ...
        <div style={{ marginBottom: 40 }}>
          ...
          >
            Timeline — order &amp; delivery history
          </div>
          <div
        ...
        <div style={{ marginBottom: 40 }}>
          ...
          >
            FilterBar — search + select filters + active chips
          </div>
          <div
            style={{
              background: "var(--surface-01)",
            ...
            <FilterBar
              ...
              filters={[
                ...
                },
                {
                  ...
                  label: "Customer",
                  options: [
                    { value: "sunrise", label: "Sunrise Cafe" },
                    { value: "airlines", label: "Ethiopian Airlines" },
                    { value: "hilton", label: "Hilton Addis" },
                  ],
                },
              ]}
          ...
          >
            ...
            <FormField label="Select field" htmlFor="ds-select">
              <SelectField
                id="ds-select"
                options={[
                  { value: "a", label: "Yirgacheffe" },
                  { value: "b", label: "Sidama" },
                  { value: "c", label: "Guji" },
                ]}
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              ...
              <Toggle
                ...
                description="Receive alerts for overdue payments"
              />
              <Toggle
                checked={false}
                onChange={() => {}}
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              ...
              <Checkbox
                ...
                description="Escalates to manager dashboard"
              />
              <Checkbox
                checked={true}
                onChange={() => {}}
      ...
      <Section id="page-blueprints" title="F3-05 · Page Blueprints">
        ...
        >
          Reusable page patterns composed from F3-04 components. Every ERP
          screen assembles one of these templates rather than designing from
          scratch. No business logic lives inside templates.
        </p>
        ...
        <div style={{ marginBottom: 48 }}>
          ...
          >
            Template 1 · DashboardTemplate — StatGrid + AttentionPanel +
            Timeline
          </div>
          <div
            style={{
          ...
          >
            ...
            >
              <div>
                ...
                >
                  Good morning, Kebede. Here is what needs your attention today.
                </div>
              </div>
              <button
                className="btn-primary"
                  ...
                  items={[
                    {
                      ...
                      body: "Two active orders require 180 KG. Current stock: 120 KG. Shortfall supplied by backend.",
                      entity: "ORD-1042",
                      timestamp: "1h ago",
                      action: { label: "Review Stock", onClick: () => {} },
                    },
                    {
                      id: 2,
                      severity: "warning",
                      title: "QC Lot Pending Manager Approval",
                      body: "Lot GR-0312 awaiting sign-off before roasting can begin.",
                      entity: "GR-0312",
                      timestamp: "2h ago",
                    ...
                    },
                    {
                      id: 3,
                      severity: "warning",
                      title: "Invoice Overdue — Ethiopian Airlines",
                      body: "INV-2024-0819 · ETB 156,000.00 · 3 days past due.",
                      entity: "INV-0819",
                      timestamp: "1d ago",
        ...
        <div style={{ marginBottom: 48 }}>
          ...
          >
            Template 2 · ListTemplate — PageHeader + FilterBar + Table +
            Pagination
          </div>
          <div
            style={{
                  ...
                  <tbody>
                    {[
                      ...
                      >
                        ...
                        <td style={{ padding: "10px 14px" }}>
                          <StatusBadge variant={row.status as any} size="sm" />
                        </td>
                        <td
                          style={{
                            padding: "10px 14px",
        ...
        <div style={{ marginBottom: 48 }}>
          ...
          >
            Template 3 · DetailTemplate — EntityHeader + Tabs + SummaryPanel +
            Timeline
          </div>
          <div
            style={{
            ...
            <EntityHeader
              ...
              meta={[
                ...
                { label: "Required By", value: "Aug 20, 2026" },
                {
                  label: "Total",
                  value: (
                    <span style={{ fontFamily: "DM Mono" }}>ETB 96,600.00</span>
                  ),
                },
              ]}
              actions={[
              ...
              <div style={{ padding: 20 }}>
                <TabPanel id="summary" active={bpDetailTab}>
                  ...
                  >
                    ...
                    >
                      <InlineAlert
                        variant="warning"
                        title="Stock availability pending"
                        description="Roasting batch not yet scheduled. Stock feasibility supplied by backend."
                        compact
                      />
                      <SummaryPanel
                        title="Order Details"
                    ...
                    <SummaryPanel
                      ...
                      rows={[
                        ...
                        {
                          label: "Status",
                          value: <StatusBadge variant="paid" size="sm" />,
                        },
                      ]}
                    />
                  </div>
                ...
                <TabPanel id="payments" active={bpDetailTab}>
                  <InlineAlert
                    ...
                    description="ETB 96,600.00 outstanding. Due Aug 23, 2026."
                    compact
                  />
                </TabPanel>
              </div>
          ...
          >
            ...
            <div style={{ padding: "24px", maxWidth: 700 }}>
              <FormSection
                ...
                description="Select the customer and delivery details for this order."
                divider={false}
              >
                <FormField label="Customer" required htmlFor="bp-customer">
                  <SelectField
                    id="bp-customer"
                    options={[
                      { value: "sc", label: "Sunrise Cafe" },
                      { value: "ea", label: "Ethiopian Airlines" },
                    ]}
              ...
              <FormSection
                title="Order Items"
                description="Specify the coffee type, grade, quantity, and packaging."
                twoCol
              >
                <FormField label="Coffee Type" required htmlFor="bp-ctype">
                  <SelectField
                    id="bp-ctype"
                    options={[
                      { value: "sid", label: "Sidamo Natural" },
                      { value: "yir", label: "Yirgacheffe" },
                      { value: "guji", label: "Guji" },
                    ]}
                ...
                <FormField label="Packaging" htmlFor="bp-pkg">
                  <SelectField
                    ...
                    options={[
                      ...
                      { value: "500g", label: "500 g Bag" },
                      { value: "bulk", label: "Bulk Sack" },
                    ]}
        ...
        <div style={{ marginBottom: 48 }}>
          ...
          >
            Template 5 · System States — Empty / Error / Permission / Not Found
            / Unsaved Changes
          </div>
          <div
            style={{
          ...
          >
            ...
            >
              ...
              <EmptyState
                icon="inbox"
                title="No orders yet"
                description="Create your first order to begin tracking fulfillment."
                action={
                  <button
                    className="btn-primary"
            ...
            >
              ...
              <EmptyState
                ...
                description="You do not have permission to view this section. Contact your General Manager to request access."
                compact
              />
            </div>
            {/* Not found */}
            ...
            >
              ...
              >
                <InlineAlert
                  ...
                  description="Leaving this page will discard all edits."
                  compact
                />
              ...
              {[
                {
                  ...
                  qty: "50 KG",
                  status: "assigned",
                  addr: "Bole, Addis Ababa",
                },
                {
                  ref: "DEL-0292",
                  customer: "Hilton Addis",
                  qty: "80 KG",
                  status: "in-progress",
                  addr: "Kirkos, Addis Ababa",
                },
              ].map((job) => (
                <div
                  key={job.ref}
                ...
                >
                  ...
                  >
                    ...
                    <StatusBadge
                      variant={
                        job.status === "assigned" ? "awaiting" : "in-progress"
                      }
                      size="sm"
                    />
                  </div>
        ...
        <div style={{ marginBottom: 24 }}>
          ...
          >
            {[
              ...
              "MobileActionBar",
              "StatGrid",
              "DashboardTemplate blueprint",
              "ListTemplate blueprint",
              "DetailTemplate blueprint",
              "CreateTemplate blueprint",
              "OperationalTemplate blueprint",
              "EmptyState",
              "ErrorState (EmptyState)",
              "PermissionDenied (EmptyState)",
              "NotFound (EmptyState)",
              "UnsavedChanges (InlineAlert + ConfirmDialog)",
      ...
      >
        ...
        >
          Token system: src/index.css · Components: src/components/ · Services:
          src/services/
        </div>
      </div>
    </div>
