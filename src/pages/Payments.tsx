...
function StatusIcon({
  ...
  if (status === "partially-paid")
    return (
      <svg width={size} height={size} viewBox="0 0 16 16" fill="none">
        <path
          d="M8 0.5a7.5 7.5 0 010 15A7.5 7.5 0 018 .5z"
          fill={color}
          fillOpacity="0.15"
          stroke={color}
        />
  ...
  return (
    <div
      style={{
        ...
        padding: "12px 18px",
        borderRadius: 10,
        background: type === "success" ? "#1A3C2D" : "#7F1D1D",
        color: "#fff",
        fontSize: 13.5,
        fontFamily: "Inter",
        fontWeight: 500,
    ...
    <div style={{ position: "relative", paddingLeft: 20 }}>
      ...
      {events.map((ev, i) => {
        ...
        return (
          <div
            key={ev.id}
            style={{ position: "relative", paddingBottom: isLast ? 0 : 18 }}
          >
            <div
              style={{
                position: "absolute",
      ...
      >
          ...
          {[
            ...
            <div
              ...
              style={{
                ...
                padding: "14px 16px",
                borderRight:
                  i < 2 ? "1px solid var(--border-neutral)" : undefined,
              }}
            >
              <div
                style={{
        ...
        >
          ...
          <div>
            ...
            >
              Payment Amount (ETB) <span style={{ color: "#DC2626" }}>*</span>
            </label>
            <input
              type="number"
              min="0"
              ...
              {bankAccounts.map((ba) => (
                <label
                  ...
                  style={{
                    ...
                    borderRadius: 8,
                    border: `2px solid ${
                      bankId === ba.id ? "#2B4D3A" : "var(--border-neutral)"
                    }`,
                    background:
                      bankId === ba.id ? "#F0FDF4" : "var(--surface-01)",
                    cursor: "pointer",
                  }}
                >
                  <input
                    ...
                    name="bankAccount"
                    value={ba.id}
                    checked={bankId === ba.id}
                    onChange={() => setBankId(ba.id)}
                    style={{ accentColor: "#2B4D3A" }}
                  />
                  <div>
                    <div
                      style={{
                    ...
                    >
                      {ba.accountName} · {ba.accountNumber}
                    </div>
                  </div>
                </label>
              ))}
          ...
          <div>
            ...
            >
              Transfer Reference <span style={{ color: "#DC2626" }}>*</span>
            </label>
            <input
              type="text"
          ...
          >
            Pricing and remaining balance calculated by the server. PHP
            determines the updated payment status.
          </div>
        ...
        >
          ...
          >
            {[
              ...
              {
                label: "Transfer Ref",
                value: transaction.transferRef,
                mono: true,
              },
              {
                label: "Bank",
                value: `${transaction.bankAccount.bankName} · ${transaction.bankAccount.accountNumber}`,
                mono: true,
              },
              ...
              ...(transaction.documentName
                ? [
                    {
                      label: "Document",
                      value: transaction.documentName,
                      mono: true,
                    },
                  ]
                : []),
          ...
          >
            Confirm you have validated this transfer against your bank
            statement.
          </div>
          ...
          >
            ...
            >
              <div>
                ...
                {tx.verifiedBy && (
                  <div
                    style={{ fontSize: 11.5, color: "#15803D", marginTop: 2 }}
                  >
                    Verified by {tx.verifiedBy} · {tx.verifiedAt}
                  </div>
                )}
                {tx.documentName && (
                  <div
              ...
              {canVerify &&
                tx.verificationStatus === "pending-verification" && (
                  <button
                    onClick={() => onVerify(tx)}
                    style={{
                      height: 32,
    ...
    <div>
      ...
      >
        <div>
          ...
          >
            Track customer payments, outstanding balances, and payment
            deadlines.
          </p>
        </div>
          ...
          <>
            {[
              ...
              <div
                ...
                style={{
                  background: card.danger ? "#FEF2F2" : "var(--surface-01)",
                  border: `1px solid ${
                    card.danger ? "#FCA5A5" : "var(--border-neutral)"
                  }`,
                  borderRadius: 10,
                  padding: "18px 20px",
              ...
              >
                <div
                  style={{
                    fontSize: 11,
                    fontFamily: "DM Mono",
                    color: card.danger ? "#DC2626" : "var(--text-muted)",
                    letterSpacing: "0.08em",
                    textTransform: "uppercase" as const,
                    marginBottom: 8,
                  }}
                ...
                {card.nav && (
                  <div
                    style={{
                      fontSize: 10.5,
                      color: card.danger ? "#DC2626" : "#B45309",
                      marginTop: 6,
                      fontFamily: "Inter",
            ...
            <div
              onClick={onNavigate ? () => onNavigate("outstanding") : undefined}
              style={{
                background: "var(--surface-01)",
                border: "1px solid var(--border-neutral)",
                borderRadius: 10,
                ...
                {payments.map((p) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <Etb amount={p.totalAmount} size={13} />
                      </td>
                      <td
                        style={{
                          padding: "12px 14px",
                      ...
                      >
                        <Etb amount={p.paidAmount} size={13} />
                      </td>
                      <td
                        style={{
                          padding: "12px 14px",
                      ...
                      >
                        <Etb amount={p.remainingAmount} size={13} />
                      </td>
                      <td
                        style={{
                          padding: "12px 14px",
                        ...
                        {p.daysRemaining ? (
                          <span
                            style={{
                              ...
                              fontSize: 12.5,
                              fontWeight: 700,
                              color: daysColor(p.daysRemainingNum),
                            }}
                          >
                            {p.daysRemaining}
                          </span>
          ...
          {payments.map((p) => {
            ...
            return (
              <div
                ...
                onClick={() => onSelectPayment(p.id)}
                style={{
                  background: overdue ? "#FFF5F5" : "var(--surface-01)",
                  border: `1px solid ${
                    overdue ? "#FCA5A5" : "var(--border-neutral)"
                  }`,
                  borderRadius: 12,
                  padding: "16px",
                  cursor: "pointer",
...
function PaymentDetailView({
  ...
  const [loading, setLoading] = useState(true)
  const [error, setError] = useState<string | null>(null)
  const [verifyingTx, setVerifyingTx] = useState<PaymentTransaction | null>(
    null,
  )
      ...
      >
        ...
        <div
          style={{
            ...
            gap: 20,
            flex: "0 0 auto",
            width: isNarrow ? "100%" : "calc(60% - 12px)",
          }}
        >
          {/* Payment header */}
          <div>
            ...
            >
              ...
              <div>
                ...
                {payment.daysRemaining && (
                  <div
                    style={{ fontSize: 12.5, color: "#B91C1C", marginTop: 1 }}
                  >
                    {payment.daysRemaining} · Deadline:{" "}
          ...
          {payment.paymentDeadline && (
            <div
              style={{
                background: "var(--surface-01)",
                border: `1px solid ${
                  isOverdue ? "#FCA5A5" : "var(--border-neutral)"
                }`,
                borderRadius: 12,
                padding: "18px 20px",
              }}
            >
              ...
              >
                <div>
                  ...
                  {payment.daysRemaining && (
                    <div
                      style={{
                        fontSize: 13,
                        fontFamily: "DM Mono",
                        color: daysColor(payment.daysRemainingNum),
                        fontWeight: 700,
                        marginTop: 5,
                      }}
                    >
                  ...
                  >
                    7 days from first verified delivery. Deadline determined by
                    the server.
                  </div>
                </div>
        ...
        >
          ...
          >
            ...
            {[
              ...
              {
                label: "Contact",
                value: payment.customer.contactName,
                mono: false,
              },
              {
                label: "First Verified Delivery",
                value: payment.firstVerifiedDelivery ?? "—",
                mono: false,
              },
            ].map((row) => (
              <div
          ...
          >
            This is not a banking or reconciliation module. Payment recording
            belongs to authorized finance staff only.
          </div>
        </div>
      </div>
...
function OutstandingPaymentsView({
  onBack,
  onSelectPayment,
}: {
  onBack: () => void
    ...
    <div>
      ...
      >
        ...
        <div>
          ...
          >
            Orders with pending or partial payment status.
          </p>
        </div>
      </div>
          ...
          {[1, 2, 3].map((i) => (
            <div
              ...
              style={{
                ...
                backgroundSize: "200% 100%",
                backgroundImage:
                  "linear-gradient(90deg,var(--surface-01) 25%,var(--border-neutral) 50%,var(--surface-01) 75%)",
              }}
            />
          ))}
        </div>
                ...
                >
                  ...
                  >
                    <div>
                      ...
                      <Etb amount={p.totalAmount} size={12} weight={600} />
                    </div>
                    <div>
                      <div
                        style={{
                      ...
                      <Etb amount={p.paidAmount} size={12} weight={600} />
                    </div>
                    <div>
                      <div
                        style={{
                      ...
                      <Etb amount={p.remainingAmount} size={12} weight={700} />
                    </div>
                  </div>
                  {p.paymentDeadline && (
                    <div
                    ...
                    >
                      Deadline: {p.paymentDeadline} · {p.daysRemaining}
                    </div>
                  )}
                </div>
              ))}
    ...
    <div>
      ...
      >
        ...
        <div>
          ...
          >
            Payments past their deadline requiring immediate attention.
          </p>
        </div>
      </div>
      ...
      {!loading && payments.length > 0 && (
        ...
        >
          ...
          >
            ...
            Contact customers and initiate payment collection.
          </span>
        </div>
      )}
      ...
      {loading ? (
        ...
        >
          ...
          <div
            style={{ fontSize: 13, color: "var(--text-muted)", marginTop: 4 }}
          >
            All outstanding payments are within their deadline.
          </div>
        </div>
      ) : (
...
export default function Payments({ routeParams }: { routeParams?: { id?: string } }) {
  ...
  return (
    <div
      style={{ padding: "28px 28px 48px", maxWidth: 1400, margin: "0 auto" }}
    >
      <style>{`
        @keyframes shimmer {
