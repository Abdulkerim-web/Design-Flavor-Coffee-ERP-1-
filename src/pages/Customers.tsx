...
const SAMPLE_CUSTOMERS: Customer[] = [
  {
    ...
    email: "procurement@hiltonaddis.com",
    ...
    lastOrderDate: "Aug 9, 2026",
    createdAt: "Jan 12, 2025",
    totalOrders: 18,
    activeOrders: 1,
    completedOrders: 17,
    totalPaid: "ETB 1,248,000.00",
    totalOverdue: "ETB 0.00",
  },
  {
    id: "c2",
    ref: "CUS-0002",
    ...
    lastOrderDate: "Aug 7, 2026",
    createdAt: "Feb 3, 2025",
    totalOrders: 24,
    activeOrders: 2,
    completedOrders: 22,
    totalPaid: "ETB 2,840,000.00",
    totalOverdue: "ETB 156,000.00",
  },
  {
    id: "c3",
    ref: "CUS-0003",
    ...
    email: "orders@sunrisecafe.et",
    contactPerson: "Dawit Haile",
    address: "Bole Road, Addis Ababa",
    location: "Addis Ababa",
    branch: "Bole Road",
    salesRep: SALES_REPS[1],
    outstandingBalance: "ETB 28,500.00",
    lastOrderDate: "Aug 8, 2026",
    createdAt: "Mar 15, 2025",
    totalOrders: 11,
    activeOrders: 1,
    completedOrders: 10,
    totalPaid: "ETB 287,000.00",
    totalOverdue: "ETB 28,500.00",
  },
  {
    id: "c4",
    ref: "CUS-0004",
    ...
    email: "purchasing@sheratonaddis.com",
    contactPerson: "Selamawit Bekele",
    address: "Taitu St, Addis Ababa",
    location: "Addis Ababa",
    salesRep: SALES_REPS[0],
    outstandingBalance: "ETB 0.00",
    lastOrderDate: "Jul 28, 2026",
    createdAt: "Apr 1, 2025",
    totalOrders: 8,
    activeOrders: 0,
    completedOrders: 8,
    totalPaid: "ETB 624,000.00",
    totalOverdue: "ETB 0.00",
  },
  {
    id: "c5",
  ...
  },
  {
    ...
    contactPerson: "Almaz Girma",
    location: "Hawassa",
    salesRep: SALES_REPS[1],
    outstandingBalance: "ETB 0.00",
    createdAt: "Jul 20, 2026",
    rejectionReason: "Incomplete business documentation. Please resubmit.",
    totalOrders: 0,
    activeOrders: 0,
    completedOrders: 0,
  },
  {
    ...
    email: "admin@unitycorp.et",
    contactPerson: "Getahun Wolde",
    address: "Kazanchis, Addis Ababa",
    location: "Addis Ababa",
    salesRep: null,
    outstandingBalance: "ETB 12,000.00",
    lastOrderDate: "Mar 4, 2026",
    createdAt: "Jun 10, 2024",
    totalOrders: 5,
    activeOrders: 0,
    completedOrders: 5,
    totalPaid: "ETB 315,000.00",
    totalOverdue: "ETB 12,000.00",
  },
]
...
const SAMPLE_ACTIVITY: ActivityEvent[] = [
  {
    id: 1,
    event: "Customer submitted for approval",
    actor: "Bereket Assefa",
    time: "Aug 5, 2026 10:22 AM",
    type: "submitted",
  },
  {
    id: 2,
...
const FULL_ACTIVITY: Record<string, ActivityEvent[]> = {
  c1: [
    {
      id: 1,
      event: "Order #ORD-1039 confirmed",
      actor: "Hiwot Tadesse",
      time: "Aug 9, 2026 09:15 AM",
      record: "#ORD-1039",
      type: "order",
    },
    {
      id: 2,
      event: "Payment registered — ETB 124,800.00",
      actor: "Tigist Alemu",
      time: "Jul 30, 2026 02:40 PM",
      record: "INV-2026-0714",
      type: "payment",
    },
    {
      id: 3,
      event: "Contact information updated",
      actor: "Hiwot Tadesse",
      time: "Jun 3, 2026 11:00 AM",
      type: "updated",
    },
    {
      id: 4,
      event: "Customer approved",
      actor: "Yohannes Bekele",
      time: "Jan 13, 2025 09:00 AM",
      type: "approved",
    },
    {
      id: 5,
  ...
  c1: [
    {
      ...
      ref: "ORD-10489",
      date: "Aug 09, 2026",
      items: "Ethiopian Yirgacheffe Light Roast",
      qty: "60 KG",
      status: "Confirmed",
      paymentStatus: "Paid",
      total: "ETB 156,000.00",
    },
    {
      id: "o2",
      ref: "ORD-10441",
      date: "Jul 28, 2026",
      items: "Sidama Medium Roast",
      qty: "48 KG",
      status: "Delivered",
      paymentStatus: "Paid",
      total: "ETB 124,800.00",
    },
    {
      id: "o3",
      ref: "ORD-10398",
  ...
  c2: [
    {
      ...
      ref: "ORD-10482",
      date: "Aug 07, 2026",
      items: "Ethiopian Yirgacheffe · Harrar Dark Roast",
      qty: "120 KG",
      status: "In Production",
      paymentStatus: "Pending",
      total: "ETB 312,000.00",
    },
    {
      id: "o5",
      ref: "ORD-10461",
