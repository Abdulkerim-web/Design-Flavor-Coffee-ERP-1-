...
const RECEIVING_QUEUE = [
  {
    id: "INSP-2026-8813",
    arrivalDate: "2026-08-06 07:30",
    supplier: "Hambela Wamena Coffee Estate",
    origin: "Guji Zone",
    declaredWeight: 600.0,
    vehicle: "AA 3-71829 (Isuzu NPR)",
    driver: "Mulatu Haile",
    poRef: "PO-2835",
    priority: "normal",
  },
  {
    id: "INSP-2026-8812",
    arrivalDate: "2026-08-06 06:45",
    supplier: "Jimma Farmers Coop",
    origin: "Jimma Zone",
    declaredWeight: 980.0,
    vehicle: "AA 4-10234 (Mitsubishi Canter)",
    driver: "Tesfaye Worku",
    poRef: "PO-2828",
    priority: "high",
  },
]
...
const COMPLETED = [
  {
    id: "QC-9024",
    lot: "GRN-SID-2026-011",
    supplier: "Bekele Agro Export",
    origin: "Sidama",
    date: "2026-08-04",
  ...
  {
    id: "QC-9022",
    lot: "GRN-BMJ-2026-002",
    supplier: "Kaffa Forest Coffee",
    origin: "Bench Maji",
    date: "2026-08-03",
    inspector: "Selamawit Bekele",
    moisture: 11.0,
  ...
  {
    id: "QC-9021",
    lot: "GRN-HRR-2026-007",
    supplier: "Harar Coffee Union",
    origin: "Harrar",
    date: "2026-08-02",
    inspector: "Henok Tadesse",
    moisture: 11.8,
  ...
  },
  {
    ...
    supplier: "Worka Washing Station",
    origin: "Yirgacheffe",
    date: "2026-07-28",
    inspector: "Henok Tadesse",
    moisture: 10.8,
...
const SPEC_THRESHOLDS = {
  moisture: {
    ...
    max: 12.0,
    unit: "%",
    label: "Optimal: 10.0% – 12.0%",
  },
  defects: {
    min: 0,
    max: 8,
    unit: "/300g",
    label: "Max allowed: 8 defects / 300g",
  },
...
function InspectionWorkspace({
  ...
  const allPass =
    allFilled &&
    [mStatus, dStatus, sStatus, vStatus, aStatus].every((s) => s === "pass")
  const anyFail =
    allFilled &&
    [mStatus, dStatus, sStatus, vStatus, aStatus].some((s) => s === "fail")
  ...
  const canCommit =
    ...
    (effectiveDecision === "approved" || rejReason !== "")

  const handleCommit = () => {
    if (!canCommit) return
    setSubmitting(true)
    setTimeout(() => {
      onCommit(effectiveDecision!, {
        moisture,
        defects,
        screenSize,
        visual,
    ...
    <div>
      ...
      <div
        style={{
          ...
          fontSize: 11.5,
          fontFamily: "DM Mono",
          color: status === "fail" ? "#DC2626" : "#9CA3AF",
        }}
      >
  ...
  return (
    <div style={{ padding: "0 0 40px" }}>
      ...
      >
        ...
        <div
          style={{ width: 1, height: 20, background: "var(--border-neutral)" }}
        />
        <div
        ...
        >
          ...
          <div>
            <div className="stat-card">
              ...
              >
                Measure and enter all values against ECFSA specification
                thresholds
              </div>
              ...
              >
                <NumInput
                  ...
                  spec={SPEC_THRESHOLDS.moisture.label}
                  step={0.1}
                  max={25}
                  status={mStatus}
                />
                <NumInput
                  label="Defect Count (per 300g)"
                  value={defects}
                  onChange={setDefects}
                  spec={SPEC_THRESHOLDS.defects.label}
                  step={1}
                  max={100}
                  status={dStatus}
                />
                <NumInput
                  label="Screen Size Uniformity (%)"
                  value={screenSize}
                  onChange={setScreenSize}
                  spec={SPEC_THRESHOLDS.screenSize.label}
                  step={1}
                  max={100}
                  status={sStatus}
                />
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <div className="stat-card" style={{ padding: "20px" }}>
              ...
              >
                Select final verdict for lot {lot.id}
              </div>
              ...
              >
                <button
                  ...
                  style={{
                    ...
                    fontFamily: "Inter",
                    border: `2px solid ${
                      effectiveDecision === "approved" ? "#16A34A" : "#E5E3DC"
                    }`,
                    background:
                      effectiveDecision === "approved" ? "#F0FDF4" : "#FAFAF8",
                ...
                >
                  ...
                  >
                    <svg
                      ...
                      fill="none"
                      stroke={
                        effectiveDecision === "approved" ? "#FFFFFF" : "#9CA3AF"
                      }
                      strokeWidth="2.5"
                    >
                      <polyline points="20 6 9 17 4 12" />
                ...
                <button
                  ...
                  style={{
                    ...
                    fontFamily: "Inter",
                    border: `2px solid ${
                      effectiveDecision === "rejected" ? "#DC2626" : "#E5E3DC"
                    }`,
                    background:
                      effectiveDecision === "rejected" ? "#FEF2F2" : "#FAFAF8",
                    transition: "all 0.2s cubic-bezier(0.16,1,0.3,1)",
                    display: "flex",
                    flexDirection: "column",
                    alignItems: "center",
                ...
                >
                  ...
                  >
                    <svg
                      ...
                      fill="none"
                      stroke={
                        effectiveDecision === "rejected" ? "#FFFFFF" : "#9CA3AF"
                      }
                      strokeWidth="2.5"
                    >
                      <line x1="18" y1="6" x2="6" y2="18" />
              ...
              {effectiveDecision === "approved" && (
                ...
                >
                  ...
                  >
                    Approval unlocks entry into Green Coffee Inventory. System
                    will auto-assign a Batch SKU and generate a receiving
                    record.
                  </div>
                  <div
                    style={{
              ...
              {effectiveDecision === "rejected" && (
                <div style={{ marginBottom: 16 }}>
                  ...
                  >
                    ...
                    >
                      This lot is blocked from entering inventory. A Supplier
                      Return Voucher will be auto-generated and sent to
                      Procurement.
                    </div>
                    <div
                      style={{
                  ...
                  <div>
                    ...
                    <select
                      ...
                      style={{
                        ...
                        borderRadius: 8,
                        border: `1.5px solid ${
                          rejReason ? "#DC2626" : "#FECACA"
                        }`,
                        background: "#FEF2F2",
                        fontSize: 13,
                        color: rejReason ? "#B91C1C" : "#9CA3AF",
                        fontFamily: "Inter",
                        outline: "none",
                        cursor: "pointer",
                    ...
                    >
                      ...
                      <option value="moisture">
                        High Moisture Content (&gt; 12.0%)
                      </option>
                      <option value="defects">
                        Excessive Primary Defects (&gt; 8 / 300g)
                      </option>
                      <option value="flavor">
                        Off-Flavor / Mold / Contamination
                      </option>
                      <option value="screensize">
                        Screen Size Below Specification
                      </option>
                      <option value="weight">
                        Declared Weight Discrepancy
                      </option>
              ...
              >
                {submitting ? (
                  ...
                  "✓ Sign & Approve Lot into Inventory"
                ) : effectiveDecision === "rejected" ? (
                  "✕ Issue Rejection & Return Note"
                ) : (
                ...
                <ResponsiveContainer width="100%" height={160}>
                    ...
                    data={[
                      {
                        ...
                        value: Math.max(
                          0,
                          100 - Math.abs((Number(moisture) - 11) * 10),
                        ),
                      },
                      {
                        axis: "Defects",
                        value: Math.max(0, 100 - Number(defects) * 8),
                      },
                  ...
                  >
                    ...
                    <Radar
                      dataKey="value"
                      stroke={
                        effectiveDecision === "rejected" ? "#DC2626" : "#2B4D3A"
                      }
                      fill={
                        effectiveDecision === "rejected" ? "#DC2626" : "#2B4D3A"
                      }
...
export default function Quality() {
  ...
  const [activeLot, setActiveLot] = useState<typeof RECEIVING_QUEUE[0] | null>(
    null,
  )
  ...
  const handleCommit = (verdict: "approved" | "rejected", data: any) => {
    ...
    const newEntry = {
      ...
      verdict,
      weight: activeLot.declaredWeight,
    }
  ...
  const approvedMonth = completedLog.filter(
    (l) => l.verdict === "approved",
  ).length
  const rejectedCount = completedLog.filter(
    (l) => l.verdict === "rejected",
  ).length
      ...
      >
        <div
          style={{
            ...
            boxShadow: `0 0 0 8px ${
              isApproved ? "rgba(22,163,74,0.08)" : "rgba(220,38,38,0.08)"
            }`,
          }}
        >
          <svg
        ...
        <div
          style={{
            ...
            background: isApproved ? "#F0FDF4" : "#FEF2F2",
            borderRadius: 10,
            border: `1px solid ${isApproved ? "#DCFCE7" : "#FECACA"}`,
          }}
        >
          {[
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        >
          <div>
            ...
            >
              Business Rule BR-INV-001 · All incoming lots must clear QC before
              inventory entry
            </p>
          </div>
        ...
        >
          ...
          >
            <div>
              ...
              >
                Lots arrived — awaiting QC clearance before inventory entry
              </div>
            </div>
            <span
              style={{
            ...
            <tbody>
              {RECEIVING_QUEUE.map((lot, i) => (
                <tr
                  ...
                  style={{
                    borderBottom:
                      i < RECEIVING_QUEUE.length - 1
                        ? "1px solid #F5F3EF"
                        : "none",
                    background:
                      lot.priority === "high" ? "#FFFBEB" : "transparent",
                ...
                >
                  ...
                  >
                    {lot.declaredWeight.toLocaleString(undefined, {
                  ...
                  <td style={{ padding: "14px 16px" }}>
                    <button
                      ...
                      onMouseEnter={(e) =>
                        (e.currentTarget.style.background = "#1F382A")
                      }
                      onMouseLeave={(e) =>
      ...
      <div className="stat-card" style={{ padding: 0, overflow: "hidden" }}>
        ...
        >
          <div>
            ...
            >
              All finalized QC decisions — August 2026
            </div>
          </div>
          <span
            style={{
          ...
          <div>
            {completedLog.map((entry, i) => (
              ...
              >
                ...
                >
                  <span>
                    {entry.origin} · {entry.inspector ?? "Inspector"}
                  </span>
                  <span
                    style={{
                      fontFamily: "DM Mono",
                      fontWeight: 700,
                      color: entry.cupScore >= 85 ? "#16A34A" : "#F59E0B",
                    }}
                  >
                    {entry.cupScore.toFixed(1)} pts
                  </span>
                  <span
                    style={{
                      fontFamily: "DM Mono",
                      color:
                        entry.moisture > 12 ? "#DC2626" : "var(--text-muted)",
                    }}
                  >
                    ...
                    <td style={{ padding: "12px 16px" }}>
                      <span
                        style={{
                          ...
                          fontSize: 12.5,
                          fontWeight: 600,
                          color: entry.moisture > 12 ? "#DC2626" : "#16A34A",
                        }}
                      >
                        {entry.moisture}%
                      </span>
                    ...
                    <td style={{ padding: "12px 16px" }}>
                      <span
                        style={{
                          ...
                          fontSize: 12.5,
                          fontWeight: 600,
                          color: entry.defects > 8 ? "#DC2626" : "#16A34A",
                        }}
                      >
                        {entry.defects}
                      </span>
