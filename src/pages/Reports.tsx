...
const TEMPLATES: ReportTemplate[] = [
  {
    ...
    description:
      "Tracks green bean shrinkage across origins and roast profiles with tolerance band overlay.",
  ...
  },
  {
    ...
    description:
      "Compares roaster utilization, batch throughput and output weight per roasting session.",
  ...
  },
  {
    ...
    description:
      "Full stock valuation ledger: receipts, QC deductions, production draws and closing balance.",
  ...
  },
  {
    ...
    description:
      "Forecasts packaging material runout dates at current consumption rate, with reorder trigger line.",
  ...
  },
  {
    ...
    description:
      "Revenue attribution per roasted batch: COGS, contribution margin and profitability ranking.",
  ...
  },
  {
    ...
    description:
      "P&L summary: gross revenue, COGS, OPEX, net profit and YoY comparison.",
  ...
  },
  {
    ...
    description:
      "QC rejection rates by supplier lot, defect category breakdown and cost-of-poor-quality impact.",
  ...
  },
  {
    ...
    description:
      "Delivery performance by driver and route, SLA breach count and customer satisfaction proxy.",
        ...
        <ResponsiveContainer width="100%" height={250}>
          ...
          >
            ...
            <Area
              ...
              strokeWidth={2}
              fill="url(#g-guji)"
              dot={{ r: 3, fill: "#2B4D3A", strokeWidth: 0 }}
            />
            <Area
              type="monotone"
              dataKey="yirgacheffe"
      ...
      return (
        <ResponsiveContainer width="100%" height={220}>
          ...
          >
            ...
            <XAxis
              dataKey="name"
              tick={{ fill: "#9CA3AF", fontSize: 10.5, fontFamily: "DM Mono" }}
              axisLine={false}
              tickLine={false}
            />
            <YAxis
              tick={{ fill: "#9CA3AF", fontSize: 9.5, fontFamily: "DM Mono" }}
              axisLine={false}
              tickLine={false}
            />
        ...
        <ResponsiveContainer width="100%" height={220}>
          ...
          >
            ...
            <YAxis
              type="category"
              dataKey="sku"
              tick={{ fill: "#374151", fontSize: 12, fontFamily: "DM Mono" }}
              axisLine={false}
              tickLine={false}
              width={70}
            />
            <Tooltip
              contentStyle={TT}
              formatter={(v: number) => `${v} days remaining`}
            />
            <ReferenceLine
              x={14}
              stroke="#DC2626"
        ...
        <ResponsiveContainer width="100%" height={220}>
          ...
          >
            ...
            <Line
              ...
              stroke="#2B4D3A"
              strokeWidth={2.5}
              dot={{ r: 5, fill: "#2B4D3A", strokeWidth: 0 }}
            />
          </LineChart>
        </ResponsiveContainer>
      )
...
const STATS: Record<ReportId, { label: string value: string sub: string }[]> = {
  "yield-variance": [
    { label: "Avg Yield", value: "85.9%", sub: "Aug 2026" },
    { label: "Out-of-Spec", value: "3 batches", sub: "this period" },
    { label: "Best Origin", value: "Yirgacheffe", sub: "89.1% avg" },
  ],
  "roaster-efficiency": [
    { label: "Total Output", value: "1,161 KG", sub: "this month" },
    { label: "Best Roaster", value: "R-01 Probat", sub: "72% util" },
    { label: "Avg Batch", value: "27.6 KG", sub: "per cycle" },
  ],
  "stock-movement": [
    { label: "Closing Stock", value: "6,150 KG", sub: "Aug 2026" },
    { label: "Received", value: "5,500 KG", sub: "this month" },
    { label: "Consumed", value: "4,780 KG", sub: "production" },
  ],
  "packaging-depletion": [
    { label: "Min Days Left", value: "21 days", sub: "2KG bag" },
    { label: "SKUs Below 25d", value: "2 SKUs", sub: "reorder urgent" },
    { label: "Total Units", value: "6,410", sub: "across all SKUs" },
  ],
  "gross-profit-per-batch": [
    { label: "Avg Margin", value: "56.8%", sub: "per batch" },
    { label: "Best Batch", value: "BAT-0289", sub: "59.0% margin" },
    { label: "Total Revenue", value: "224K ETB", sub: "Aug batches" },
  ],
  "monthly-revenue": [
    { label: "Revenue Aug", value: "1.45M ETB", sub: "+18.2% MoM" },
    { label: "Net Profit", value: "522K ETB", sub: "57.2% margin" },
    { label: "OPEX", value: "276K ETB", sub: "+4.1% MoM" },
  ],
  "supplier-defect": [
    { label: "Total Rejections", value: "11 lots", sub: "Aug 2026" },
    { label: "Worst Supplier", value: "Yirgalem", sub: "5 rejections" },
    { label: "COPQ", value: "156K ETB", sub: "total cost" },
  ],
  "delivery-fulfillment": [
    { label: "Avg OTD Rate", value: "92.6%", sub: "Aug 2026" },
    { label: "SLA Breaches", value: "9 deliveries", sub: "past 5 weeks" },
    { label: "Best Week", value: "W31", sub: "96.3% OTD" },
  ],
}
  ...
  return (
    <button
      ...
      style={{
        ...
        padding: "7px 10px",
        borderRadius: 7,
        border: `1.5px solid ${checked ? color + "40" : "#E5E3DC"}`,
        background: checked ? color + "08" : "#FAFAF8",
        cursor: "pointer",
  ...
  return (
    <div
      ...
      style={{
        ...
        background: "var(--surface-01)",
        border: `1.5px solid ${
          hovered ? "#2B4D3A40" : "var(--border-neutral)"
        }`,
        borderRadius: 12,
        display: "flex",
        ...
        boxShadow: hovered ? "0 4px 16px rgba(43,77,58,0.1)" : "none",
      }}
    >
      <div style={{ display: "flex", alignItems: "flex-start", gap: 12 }}>
        <div
          style={{
            ...
            height: 36,
            borderRadius: 9,
            background: hovered ? "#2B4D3A" : "#F5F3EF",
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
            flexShrink: 0,
...
export default function Reports() {
  ...
  const [roasts, setRoasts] = useState<Set<RoastKey>>(
    new Set(["medium", "dark"]),
  )
        ...
        >
          ...
          >
            <div>
              ...
              >
                Understand business performance, inventory, operations, finance,
                sales, roasting, delivery, and other authorized activity.
              </p>
            </div>
            <div
              style={{
            ...
            <div style={{ padding: "52px 24px", textAlign: "center" }}>
              ...
              <button
                onClick={() => {
                  ...
                  setTimeout(() => setCatalogState("ok"), 900)
                }}
                style={{
                  padding: "8px 20px",
                  borderRadius: 8,
          ...
          {catalogState === "ok" && TEMPLATES.length === 0 && (
            <div style={{ padding: "52px 24px", textAlign: "center" }}>
              ...
              <div style={{ fontSize: 13, color: "var(--text-muted)" }}>
                No data available for the selected period. Try changing your
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div>
            ...
            >
              Custom report builder · Multi-dimensional analytics · Automated
              scheduling
            </p>
          </div>
      ...
      >
        ...
        <div
          style={{
            width: isNarrow ? "100%" : 272,
            minWidth: isNarrow ? "100%" : 272,
            background: "var(--surface-01)",
                    ...
                    >
                      <div
                        style={{
                          ...
                          height: 28,
                          borderRadius: 7,
                          background: active ? "#2B4D3A" : "#F5F3EF",
                          display: "flex",
                          alignItems: "center",
                          justifyContent: "center",
                          flexShrink: 0,
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              ...
              >
                ...
                {[
                  {
                    name: "Monthly Revenue Statement",
                    freq: "Every 1st · 07:00 EAT",
                    recip: "gm@flavorcoffee.et",
                    on: true,
                  },
                  {
                    name: "Weekly Yield Variance",
                    freq: "Every Monday · 08:00",
                    recip: "ops@flavorcoffee.et",
                    on: true,
                  },
                  {
                    name: "Supplier Defect Summary",
                    freq: "Every Friday · 16:00",
                    recip: "qc@flavorcoffee.et",
                    on: false,
                  },
                ].map((s) => (
                  <div
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 11 }}>
              ...
              >
                ...
                >
                  {([
                    ["guji", "Guji", "#2B4D3A"],
                    ["yirgacheffe", "Yirgacheffe", "#1D4ED8"],
                    ["harrar", "Harrar", "#B45309"],
                    ["sidama", "Sidama", "#7C3AED"],
                    ["limu", "Limu", "#0E7490"],
                  ] as [OriginKey, string, string][]).map(([k, l, c]) => (
                    <CheckBtn
                      key={k}
                      checked={origins.has(k)}
                      color={c}
                      label={l}
                      onClick={() => toggleOrigin(k)}
                    />
                  ))}
                </div>
              </div>
              ...
              >
                ...
                >
                  {([
                    ["light", "Light Roast", "#F59E0B"],
                    ["medium", "Medium Roast", "#B45309"],
                    ["dark", "Dark Roast", "#374151"],
                  ] as [RoastKey, string, string][]).map(([k, l, c]) => (
                    <CheckBtn
                      key={k}
                      checked={roasts.has(k)}
                      color={c}
                      label={l}
                      onClick={() => toggleRoast(k)}
                    />
                  ))}
                </div>
              </div>
              ...
              >
                ...
                >
                  {([
                    ...
                    <button
                      key={k}
                      onClick={() => setExportFmt(k)}
                      style={{
                        padding: "10px 0",
                        borderRadius: 8,
                        border: `1.5px solid ${
                          exportFmt === k ? "#2B4D3A" : "#E5E3DC"
                        }`,
                        background: exportFmt === k ? "#F0FDF4" : "#FAFAF8",
                        cursor: "pointer",
                        transition: "all 0.12s",
                        display: "flex",
                    ...
                    >
                      ...
                      <span
                        style={{
                          ...
                          fontFamily: "DM Mono",
                          fontWeight: 700,
                          color: exportFmt === k ? "#2B4D3A" : "#6B7280",
                        }}
                      >
                        {l}
                      </span>
                ...
                >
                  {exportFmt === "pdf"
                    ? "Print-ready A4 with letterhead"
                    : exportFmt === "xlsx"
                      ? "Multi-sheet workbook + pivot tables"
                      : "Raw tabular CSV for BI ingestion"}
                </div>
              </div>
              ...
              >
                ...
                >
                  ...
                  <button
                    ...
                    style={{
                      ...
                      height: 22,
                      borderRadius: 999,
                      background: autoEmail ? "#2B4D3A" : "#E5E3DC",
                      border: "none",
                      cursor: "pointer",
                ...
                {autoEmail && (
                  ...
                  >
                    ...
                    <input
                      defaultValue="gm@flavorcoffee.et"
                      style={{
                        width: "100%",
                        padding: "5px 8px",
                        borderRadius: 5,
                    ...
                    >
                      <div
                        style={{
                          ...
                          background:
                            "linear-gradient(90deg, #2B4D3A, #4A7C5A)",
                          borderRadius: 99,
                ...
                {generated && (
                  ...
                  >
                    ...
                    <div>
                      ...
                      >
                        {selected.title.slice(0, 28)}….{exportFmt}
                      </div>
                      <div
                        style={{
                          fontSize: 10,
                      ...
                      >
                        {selected.estimatedRows} records · {startDate} →{" "}
                        {endDate}
                      </div>
                    </div>
                  </div>
