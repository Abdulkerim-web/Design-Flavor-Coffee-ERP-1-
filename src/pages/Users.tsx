...
const MODULES: PermRow[] = [
  ...
  {
    module: "roasting-exec",
    label: "Roasting Execution",
  ...
  },
  {
    module: "packaging",
    label: "Packaging & FG",
    icon: "M21 16V8a2 2 0 00-1-1.73l-7-4a2 2 0 00-2 0l-7 4A2 2 0 003 8v8M12 22.08V12",
  },
  {
    module: "delivery",
    ...
    >
      ...
      <div
        style={{
          ...
          animation: "slideInPalette 0.2s cubic-bezier(0.16,1,0.3,1)",
        }}
      >
        ...
        >
          <div>
            ...
            >
              New account · Credentials emailed on save
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div style={{ padding: "20px 24px" }}>
          <div style={{ display: "grid", gap: 14, marginBottom: 18 }}>
            {[
              ["Full Name", name, setName, "text", "e.g. Almaz Bekele"],
              [
                "Email Address",
                email,
                setEmail,
                "email",
                "e.g. almaz.b@flavorcoffee.et",
              ],
            ].map(([label, val, fn, type, placeholder]) => (
              <div key={label as string}>
                ...
                >
                  {label as string} <span style={{ color: "#DC2626" }}>*</span>
                </label>
                <input
                  type={type as string}
                  value={val as string}
            ...
            <div>
              ...
              >
                {(Object.entries(
                  ROLES,
                ) as [RoleId, typeof ROLES[RoleId]][]).map(([k, v]) => (
              ...
              {role && (
                <div
                  style={{
                    ...
                    border: `1px solid ${ROLES[role].border}`,
                    fontSize: 12,
                ...
                >
                  ...
                  {
                    Object.values(INITIAL_MATRIX[role]).filter((v) =>
          ...
          <div style={{ display: "flex", gap: 10 }}>
            ...
            <button
              ...
              style={{
                ...
                borderRadius: 8,
                border: "none",
                background: done ? "#16A34A" : !canSave ? "#E5E3DC" : "#2B4D3A",
...
function PermCheck({
  ...
  if (locked) {
    return (
      <div
        title="Security-hardcoded · Cannot be changed"
        style={{
          width: 22,
          height: 22,
          borderRadius: 5,
  ...
  return (
    <button
      ...
      style={{
        ...
        height: 22,
        borderRadius: 5,
        border: `1.5px solid ${checked ? roleColor : "#D1D5DB"}`,
        background: checked ? roleColor : "#FFFFFF",
        display: "flex",
        alignItems: "center",
        justifyContent: "center",
        cursor: "pointer",
...
export default function Users() {
  ...
  const permCountForRole = (role: RoleId) => {
    ...
    MODULES.forEach((m) =>
      SCOPES.forEach((s) => {
        if (matrix[role][m.module][s.id]) count++
      }),
    )
    return count
  }
      ...
      >
        ...
        >
          <div>
            ...
            >
              Account directory · Role permission matrix · Security token
              control
            </p>
          </div>
          <div
        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex", gap: 4, flexWrap: "wrap" as const }}>
              {(Object.entries(ROLES) as [RoleId, typeof ROLES[RoleId]][]).map(
                ([k, v]) => {
                  ...
                  return (
                    <button
                      ...
                      style={{
                        ...
                        border: `1.5px solid ${isActive ? v.color : "#E5E3DC"}`,
                    ...
                    >
                      ...
                      <div
                        style={{
                          fontSize: 10,
                          fontFamily: "DM Mono",
                          color: isActive ? v.color + "AA" : "#9CA3AF",
                          marginTop: 1,
                        }}
                      >
                        Tier {v.tier} · {count}p
          ...
          <div style={{ flex: 1, overflowY: "auto", padding: "20px 22px" }}>
            ...
            <div
              style={{
                background: "var(--surface-01)",
                border: `1.5px solid ${ROLES[activeRole].border}`,
                borderRadius: 12,
                padding: "14px 18px",
                marginBottom: 16,
                display: "flex",
            ...
            >
              ...
              <div style={{ flex: 1 }}>
                ...
                >
                  {permCountForRole(activeRole)} active permissions · Tier{" "}
                  {ROLES[activeRole].tier} access level ·{" "}
                  {users.filter((u) => u.role === activeRole).length} users
                  assigned
                </div>
              </div>
              ...
              {isMobile ? (
                ...
                <div>
                  {MODULES.map((mod, mi) => {
                    ...
                    const anyEnabled = rowPerms.some(
                      (r) => r.checked && !r.locked,
                    )
                    return (
                      <div
                        key={mod.module}
                        style={{
                          ...
                          borderBottom:
                            mi < MODULES.length - 1
                              ? "1px solid #F0EDE8"
                              : "none",
                          background: mi % 2 === 0 ? "#FFFFFF" : "#FAFAF8",
                        }}
                      >
                        <div
                          style={{
                        ...
                        >
                          ...
                          >
                            <svg
                              ...
                              viewBox="0 0 24 24"
                              fill="none"
                              stroke={anyEnabled ? roleColor : "#9CA3AF"}
                              strokeWidth="1.75"
                            >
                              {mod.icon
                                .split("M")
                        ...
                        {rowPerms.map((p) => (
                          ...
                          >
                            ...
                            <PermCheck
                              ...
                              roleColor={roleColor}
                              onChange={() =>
                                togglePerm(activeRole, mod.module, p.scope.id)
                              }
                            />
                          </div>
                        ))}
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: 9,
                  border: "none",
                  background: savedAnim ? "#16A34A" : "#2B4D3A",
                  color: "#FFFFFF",
                  fontSize: 13.5,
                  fontWeight: 700,
                  cursor: "pointer",
                  ...
                  alignItems: "center",
                  gap: 7,
                  boxShadow: "0 3px 10px rgba(43,77,58,0.25)",
                }}
              >
                {savedAnim ? (
                  <>
          ...
          >
            ...
            >
              ...
              <strong style={{ color: "var(--text-primary)" }}>
                {users.find((u) => u.id === resetTarget)?.email}
              </strong>
            ...
            <div style={{ display: "flex", gap: 9 }}>
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: 8,
                  border: "none",
                  background: confirmReset ? "#16A34A" : "#DC2626",
                  color: "#FFFFFF",
                  fontSize: 13.5,
                  fontWeight: 700,
                  cursor: "pointer",
                ...
                setUsers((prev) =>
                  prev.map((u) =>
                    u.id === editUser.id
                      ? {
                          ...u,
                          role: e.target.value as RoleId,
                          avatarColor: ROLES[(e.target.value as RoleId)].color,
                        }
                      : u,
                  ),
                )
