...
const SAMPLE_ORDERS: Order[] = [
  {
    ...
    timeline: mkTl("pending-confirmation"),
  },
...

  {
    ...
    timeline: mkTl("roasted-needs-review"),
  },

  {
    ...
    timeline: mkTl("ready-for-delivery"),
  },
...

  {
    ...
    items: [
      ...
      },
      {
        ...
        unit: "KG",
        unitPrice: "ETB 1,680.00",
        lineTotal: "ETB 16,800.00",
      },
    ],
    totalQty: "25 KG",
    coffeeLabel: "Ethiopian Yirgacheffe + 1 more",
    subtotal: "ETB 46,050.00",
    vat: "ETB 6,907.50",
    total: "ETB 52,957.50",
    feasibility: {
      state: "warning",
    ...
    payment: {
      ...
      total: "ETB 52,957.50",
      paid: "ETB 0.00",
      remaining: "ETB 52,957.50",
    },
    deliveryDate: "Aug 10, 2026",
    deliveryAddress: "Adama City Center",
    createdAt: "Aug 8, 2026",
    timeline: mkTl("confirmed"),
  },
]
