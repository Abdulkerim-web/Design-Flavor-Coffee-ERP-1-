...
const SAMPLE_NOTIFS: Notif[] = [
  {
    ...
    module: "Orders",
    moduleId: "orders",
    title: "Urgent order requires review",
    what: "Order #ORD-1042 has insufficient green coffee for the requested roasted quantity.",
    why: "Stock check shows a shortfall of 10.6 KG. Manager confirmation required before roasting begins.",
    action: "Review Order",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    category: "urgent",
    read: false,
    timeRaw: 1000 * 60 * 60 * 2,
    time: "2h ago",
    module: "Quality",
    moduleId: "quality",
    title: "QC rejection — Lot #GR-0291",
    what: "Moisture content 14.6% exceeded the 13% threshold.",
    why: "500 KG of Sidama Grade 1 quarantined. Cannot proceed to roasting until reviewed.",
  ...
  },
  {
    ...
    what: "Sunrise Café has been submitted by a sales representative.",
    why: "Customer profile and credit terms require manager review before activation.",
  ...
  },
  {
    ...
    what: "Vehicle maintenance expense ETB 8,500 submitted by Solomon Tesfaye.",
    why: "Expenses above ETB 5,000 require manager sign-off.",
    action: "Review Expense",
  },
  {
    id: 6,
    category: "warning",
    read: true,
    timeRaw: 1000 * 60 * 60 * 24,
    time: "1d ago",
    module: "Finance",
    moduleId: "finance",
    title: "Payment deadline approaching",
    what: "ABC Hotel has an outstanding balance of ETB 48,200 approaching its payment deadline.",
    why: "Payment is due in 2 days. Customer contact may be required.",
    action: "View Payment",
  },
  {
    id: 7,
    category: "warning",
    read: true,
    timeRaw: 1000 * 60 * 60 * 36,
    time: "1.5d ago",
    module: "Orders",
    moduleId: "orders",
    title: "Order delivery overdue",
    what: "Order #ORD-1035 was due for delivery 8 hours ago.",
    why: "Customer has not received confirmation. Delivery status unknown.",
  ...
  },
  {
    ...
    category: "info",
    read: true,
    timeRaw: 1000 * 60 * 60 * 48,
    time: "2d ago",
    module: "Orders",
    moduleId: "orders",
    title: "Roasting completed",
    what: "Order #ORD-1024 has been reported as successfully roasted.",
    why: "Batch RB-2891 produced 48 KG of Guji Medium. Ready for packing.",
    action: "View Order",
  },
  {
    id: 9,
    category: "info",
    read: true,
    timeRaw: 1000 * 60 * 60 * 50,
    time: "2d ago",
    module: "Delivery",
    moduleId: "delivery",
    title: "Delivery completed — #ORD-1038",
  ...
  },
  {
    ...
    category: "info",
    read: true,
    timeRaw: 1000 * 60 * 60 * 72,
    time: "3d ago",
    module: "Reports",
    moduleId: "reports",
    title: "Monthly report generated",
    what: "July 2026 operations report is ready for review.",
    why: "Includes roasting yield, delivery performance, and revenue summary.",
    action: "View Report",
  },
]
