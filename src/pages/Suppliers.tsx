...
const SUPPLIERS = [
  {
    id: "SUP-001",
    name: "Kayon Mountain Coffee Farm PLC",
    shortName: "Kayon Mountain Farm",
    origin: "Guji Zone",
    region: "Oromia",
    tin: "ETH-0021-4891",
    contact: "Ato Gemechu Tadesse",
    phone: "+251 911 234 567",
    email: "gemechu@kayoncoffee.et",
    address: "Kebele 04, Shakiso District, Guji Zone, Oromia Region",
    rating: 4.9,
    deliveries: 12,
    totalKg: 45000,
    totalSpend: 20250000,
    ...
    avgQcScore: 88.5,
    status: "active",
    variety: ["Guji Natural", "Guji Washed"],
    initials: "KM",
    color: "#2B4D3A",
    procurement: [
      {
    ...
    radarData: [
      { axis: "Bean Uniformity", value: 94 },
      { axis: "Moisture", value: 91 },
      { axis: "Cupping Score", value: 89 },
      { axis: "Timeliness", value: 96 },
    ...
    docs: [
      ...
      {
        name: "Supplier Agreement 2026-27",
        type: "PDF",
        size: "2.8 MB",
        date: "2026-02-14",
        icon: "📝",
  ...
  {
    id: "SUP-002",
    name: "Hambela Wamena Coffee Estate",
    shortName: "Hambela Estate",
    origin: "Guji Zone",
    region: "Oromia",
    tin: "ETH-0034-7712",
    contact: "W/ro Almaz Bekele",
    phone: "+251 922 345 678",
    email: "almaz@hambelacoffee.et",
    address: "Hambela Wamena, Guji Zone, Oromia Region",
    rating: 4.7,
    deliveries: 8,
    totalKg: 28000,
    totalSpend: 13440000,
    ...
    radarData: [
      { axis: "Bean Uniformity", value: 88 },
      { axis: "Moisture", value: 85 },
      { axis: "Cupping Score", value: 86 },
      { axis: "Timeliness", value: 90 },
  ...
  {
    id: "SUP-003",
    name: "Worka Washing Station Coop",
    shortName: "Worka Washing Station",
    origin: "Yirgacheffe",
    region: "Gedeo Zone",
    tin: "ETH-0056-3301",
    contact: "Ato Tesfaye Dima",
    phone: "+251 933 456 789",
    email: "worka@yirgacheffe.et",
    address: "Worka Kebele, Yirgacheffe Town, Gedeo Zone, SNNPR",
    rating: 4.8,
    deliveries: 14,
    totalKg: 52000,
    totalSpend: 27040000,
    ...
    avgQcScore: 90.1,
    status: "active",
    variety: ["Yirgacheffe Washed", "Yirgacheffe Natural"],
    initials: "WW",
    color: "#6D28D9",
    procurement: [
      {
    ...
    radarData: [
      { axis: "Bean Uniformity", value: 96 },
      { axis: "Moisture", value: 94 },
      { axis: "Cupping Score", value: 92 },
      { axis: "Timeliness", value: 88 },
  ...
  {
    id: "SUP-004",
    name: "Harar Coffee Export Union",
    shortName: "Harar Coffee Union",
    origin: "East Hararghe",
    region: "Oromia",
    tin: "ETH-0078-5520",
    contact: "Ato Mohammed Hassan",
    phone: "+251 944 567 890",
    email: "export@hararcoffee.et",
    address: "Harar Town, East Hararghe Zone, Oromia Region",
    rating: 4.4,
    deliveries: 9,
    totalKg: 31500,
    totalSpend: 12285000,
    ...
    avgQcScore: 82.4,
    status: "active",
    variety: ["Harrar Grade 1", "Harrar Grade 2"],
    initials: "HU",
    color: "#92400E",
    procurement: [
      {
    ...
    radarData: [
      { axis: "Bean Uniformity", value: 80 },
      { axis: "Moisture", value: 78 },
      { axis: "Cupping Score", value: 82 },
      { axis: "Timeliness", value: 85 },
      { axis: "Packaging", value: 83 },
    ],
    docs: [
      {
        name: "Export License 2026",
        type: "PDF",
        size: "1.3 MB",
        date: "2026-02-01",
        icon: "📄",
  ...
  {
    id: "SUP-005",
    name: "Jimma Farmers Cooperative",
    shortName: "Jimma Farmers Coop",
    origin: "Jimma Zone",
    region: "Oromia",
    tin: "ETH-0091-6634",
    contact: "W/ro Hirut Mengistu",
    phone: "+251 955 678 901",
    email: "hirut@jimmacoop.et",
    address: "Jimma Town, Jimma Zone, Oromia Region",
    rating: 4.6,
    deliveries: 11,
    totalKg: 38000,
    totalSpend: 14440000,
    ...
    avgQcScore: 85.0,
    status: "active",
    variety: ["Limu Grade 1", "Jimma Grade 2"],
    initials: "JF",
    color: "#065F46",
    procurement: [
      {
    ...
    radarData: [
      { axis: "Bean Uniformity", value: 85 },
      { axis: "Moisture", value: 87 },
      { axis: "Cupping Score", value: 85 },
      { axis: "Timeliness", value: 82 },
  ...
  {
    id: "SUP-006",
    name: "Kaffa Forest Coffee Estate",
    shortName: "Kaffa Forest Coffee",
    origin: "Bench Maji Zone",
    region: "SNNPR",
    tin: "ETH-0103-8847",
    contact: "Ato Dawit Getahun",
    phone: "+251 966 789 012",
    email: "dawit@kaffaforest.et",
    address: "Maji Town, Bench Maji Zone, SNNPR",
    rating: 4.5,
    deliveries: 6,
    totalKg: 18000,
    totalSpend: 6480000,
    ...
    radarData: [
      { axis: "Bean Uniformity", value: 89 },
      { axis: "Moisture", value: 93 },
      { axis: "Cupping Score", value: 87 },
      { axis: "Timeliness", value: 84 },
