...
export type OrderStatusKey = "pending-confirmation" | "confirmed" | "stock-shortage" | "roasting" | "awaiting-storekeeper" | "roasted-needs-review" | "packing" | "packing-needs-review" | "ready-for-delivery" | "partially-delivered" | "awaiting-customer-confirmation" | "fully-delivered" | "payment-pending" | "partially-paid" | "overdue" | "paid" | "completed" | "cancelled"
...
export const ORDER_STATUS_MAP: Record<OrderStatusKey, StatusConfig> = {
  "pending-confirmation": {
    ...
    group: "pending",
    description: "Awaiting manager review and confirmation.",
  },
  confirmed: {
    label: "Confirmed",
    color: "#1D4ED8",
    ...
    group: "active",
    description: "Confirmed and green coffee reserved.",
  },
  "stock-shortage": {
    ...
    group: "warning",
    description: "Awaiting managerial decision due to insufficient stock.",
  },
  roasting: {
    label: "Roasting",
    color: "#92400E",
    ...
    group: "active",
    description: "Green coffee is currently being roasted.",
  },
  "awaiting-storekeeper": {
    ...
    group: "active",
    description: "Roasting complete. Storekeeper must accept roasted output.",
  },
  "roasted-needs-review": {
    label: "Roasted — Needs Review",
    color: "#B45309",
    bg: "#FFFBEB",
    border: "#FDE68A",
    bar: "#F59E0B",
    iconPath:
      "M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0zM12 9v4M12 17h.01",
    group: "warning",
    description: "Output weight discrepancy. Manager review required.",
  },
  packing: {
    label: "Packing",
    color: "#0E7490",
    ...
    group: "active",
    description: "Roasted coffee is being packed for delivery.",
  },
  "packing-needs-review": {
    label: "Packing — Needs Review",
    color: "#B45309",
    bg: "#FFFBEB",
    border: "#FDE68A",
    bar: "#F59E0B",
    iconPath:
      "M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0zM12 9v4M12 17h.01",
    group: "warning",
    description: "Packing weight discrepancy. Manager review required.",
  },
  "ready-for-delivery": {
    ...
    iconPath:
      "M9 11l3 3L22 4M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11",
    group: "active",
    description: "Order is packed and ready for the delivery team.",
  },
  "partially-delivered": {
    ...
    group: "active",
    description: "Some deliveries complete; remaining scheduled.",
  },
  "awaiting-customer-confirmation": {
    ...
    iconPath:
      "M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10zM12 8v4M12 16h.01",
    group: "active",
    description: "Awaiting customer receipt confirmation.",
  },
  "fully-delivered": {
    ...
    group: "financial",
    description: "All deliveries verified. Awaiting payment.",
  },
  "payment-pending": {
    ...
    group: "financial",
    description: "Delivered. Awaiting full payment.",
  },
  "partially-paid": {
    ...
    iconPath: "M12 1v22M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6",
    group: "financial",
    description: "Partial payment received. Remaining balance outstanding.",
  },
  overdue: {
    label: "Overdue",
    color: "#B91C1C",
  ...
  completed: {
    ...
    iconPath: "M22 11.08V12a10 10 0 11-5.93-9.14M22 4L12 14.01l-3-3",
    group: "terminal",
    description: "Order fully delivered and paid. No further action required.",
  },
  cancelled: {
    label: "Cancelled",
    color: "#6B7280",
...
export const FEASIBILITY_MAP: Record<FeasibilityKey, {
  label: string
  color: string
  bg: string
  border: string
  ...
  warning: {
    ...
    iconPath:
      "M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0zM12 9v4M12 17h.01",
    description:
      "Order can be fulfilled, but stock is approaching the minimum threshold.",
  },
  insufficient: {
    ...
    iconPath:
      "M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0zM12 9v4M12 17h.01",
    description:
      "Insufficient green coffee is currently available to safely fulfil this order.",
  },
}

export const PAYMENT_STATUS_MAP: Record<PaymentStatusKey, {
  label: string
  color: string
  bg: string
  border: string
...
export function getStatusConfig(status: string): StatusConfig {
  return (
    ORDER_STATUS_MAP[(status as OrderStatusKey)] ?? {
      label: status,
      color: "#6B7280",
      bg: "#F9FAFB",
      border: "#E5E7EB",
