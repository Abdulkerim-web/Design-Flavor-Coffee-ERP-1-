...
const VARIANT_TOKENS: Record<StatVariant, {
  iconBg: string
  iconColor: string
  darkIconBg: string
  ...
  info: {
    iconBg: "#DBEAFE",
    iconColor: "#1D4ED8",
    darkIconBg: "rgba(96,165,250,0.15)",
    ...
    return (
      ...
      >
        <div
          ...
          style={{ height: 12, width: 90, borderRadius: 6, marginBottom: 14 }}
        />
        <div
          className="skeleton-shimmer"
          style={{ height: 28, width: 140, borderRadius: 6, marginBottom: 8 }}
        />
        <div
          className="skeleton-shimmer"
          style={{ height: 11, width: 80, borderRadius: 5 }}
        />
      </div>
    )
  }
