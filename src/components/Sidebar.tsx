...
const icons = {
  ...
  quality:
    "M14 2v6l3 5c1.5 2.6-.3 5-2.7 5H9.7C7.3 18 5.5 15.6 7 13l3-5V2M6 2h12",
  production:
    "M8.5 14.5A2.5 2.5 0 0011 12c0-1.38-.5-2-1-3-1.072-2.143-.224-4.054 2-6 .5 2.5 2 4.9 4 6.5 2 1.6 3 3.5 3 5.5a7 7 0 11-14 0c0-1.153.433-2.294 1-3a2.5 2.5 0 002.5 3z",
  ...
  employees:
    "M16 21v-2a4 4 0 00-4-4H6a4 4 0 00-4 4v2M12 11a4 4 0 100-8 4 4 0 000 8zM19 8v6M22 11h-6",
  settings:
  ...
  expenses:
    "M21 16V8a2 2 0 00-1-1.73l-7-4a2 2 0 00-2 0l-7 4A2 2 0 003 8v8a2 2 0 001 1.73l7 4a2 2 0 002 0l7-4A2 2 0 0021 16zM12 2v20M2 12h20",
  payroll:
    "M20 7H4a2 2 0 00-2 2v10a2 2 0 002 2h16a2 2 0 002-2V9a2 2 0 00-2-2zM16 3H8L6 7h12l-2-4zM12 14a2 2 0 100-4 2 2 0 000 4z",
  approvals:
    "M9 11l3 3L22 4M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11",
  notifications:
...
const NAV = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "users", label: "User Roles", icon: icons.users },
      { id: "settings", label: "Settings", icon: icons.settings },
      {
        id: "design-system",
        label: "Design System",
        icon: "M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10-4.477 10-10 10zM7 12a5 5 0 0010 0M7 12a5 5 0 0110 0M12 7v10",
      },
    ],
  },
]
...
export default function Sidebar({
  ...
  const asideStyle: CSSProperties = isMobile
    ...
    : {
        ...
        overflow: "hidden",
        transition:
          "width 220ms cubic-bezier(0.16,1,0.3,1), min-width 220ms cubic-bezier(0.16,1,0.3,1)",
        position: "relative",
        flexShrink: 0,
      }
      ...
      <aside style={asideStyle}>
          ...
          {effectiveCollapsed ? (
            <div
              style={{
                ...
                boxShadow: "0 2px 8px rgba(43,77,58,0.2)",
                cursor: "pointer",
              }}
            ...
            <button
              ...
              onMouseLeave={(e) =>
                (e.currentTarget.style.background = companyOpen
                  ? "var(--surface-02)"
                  : "transparent")
              }
            >
              <div
                style={{
                  ...
                  flexShrink: 0,
                  background:
                    "linear-gradient(135deg, #2B4D3A 0%, #3D6B54 100%)",
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
        ...
        <nav
          style={{
            flex: 1,
            overflowY: "auto",
            padding: effectiveCollapsed ? "8px 0" : "8px 8px",
          }}
        >
          {NAV.filter((group) =>
            group.items.some(
              (item) => !currentRole || canRead(currentRole, item.id),
            ),
          ).map((group) => (
            <div
              key={group.group}
              style={{ marginBottom: effectiveCollapsed ? 8 : 16 }}
            >
              {!effectiveCollapsed && (
                <div
                  style={{
              ...
              {group.items
                .filter((item) => !currentRole || canRead(currentRole, item.id))
                .map((item) => {
                  ...
                  return (
                    <button
                      ...
                      style={{
                        ...
                        paddingBottom: effectiveCollapsed
                          ? 9
                          : isMobile
                            ? 11
                            : 7,
                          ...
                          return (
                            <div
                              style={{
                                ...
                                border: `1px solid ${
                                  isDark ? bc.darkBorder : bc.border
                                }`,
                                display: "flex",
                                alignItems: "center",
                                justifyContent: "center",
        ...
        <div
          style={{
            padding: effectiveCollapsed ? "10px 0" : "10px 8px 12px",
          ...
          {effectiveCollapsed ? (
            ...
            >
              <button
                onClick={onLogout}
                title={
                  currentUser ? `${currentUser.name} · Sign out` : "Sign out"
                }
                style={{
                  width: 32,
                  height: 32,
            ...
            >
              ...
              <button
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.background = "#EEEDE8"
