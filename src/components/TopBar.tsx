    ...
    >
        ...
        >
          <div
            style={{
              ...
              border: `1px solid ${
                isDark ? "rgba(74,222,128,0.18)" : "#DCFCE7"
              }`,
              cursor: "default",
            }}
          >
          ...
          {statusHover && (
            ...
            >
              ...
              {[
                ["Database", "18ms", "#4ADE80"],
                ["API Gateway", "24ms", "#4ADE80"],
                ["Auth", "12ms", "#4ADE80"],
              ].map(([s, ms, c]) => (
                <div
                  key={s}
        ...
        <button
          ...
          style={{
            ...
            background: notifOpen
              ...
              : "var(--bg-primary)",
            border: `1px solid ${
              notifOpen ? "var(--border-neutral)" : "var(--border-neutral)"
            }`,
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
          ...
          {unreadCount > 0 && (
            <div
              style={{
                ...
                borderRadius: 7,
                background:
                  urgentCount > 0 ? "var(--sem-danger)" : "var(--sem-warning)",
      ...
      <div ref={userMenuRef} style={{ position: "relative", flexShrink: 0 }}>
        <button
          ...
          title={
            currentUser
              ? `${currentUser.name} · ${ROLES[currentUser.role]?.label}`
              : "Account"
          }
        >
            ...
            >
              ...
              <div
                style={{
                  ...
                  borderRadius: 999,
                  background:
                    ROLES[currentUser.role]?.bg ?? "var(--surface-02)",
                  border: `1px solid ${ROLES[currentUser.role]?.border ?? "var(--border-neutral)"}`,
                  fontSize: 10.5,
                  fontFamily: "DM Mono",
                  color:
                    ROLES[currentUser.role]?.color ?? "var(--text-secondary)",
                }}
              >
