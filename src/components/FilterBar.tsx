          ...
          {filters
            ...
            .map((f) => {
              ...
              return (
                ...
                >
                  <span
                    style={{ fontWeight: 400, color: "rgba(43,77,58,0.6)" }}
                  >
                    {f.label}:
                  </span>
                  <span style={{ fontWeight: 600 }}>
                    {opt?.label ?? activeFilters[f.key]}
                  </span>
                  <button
