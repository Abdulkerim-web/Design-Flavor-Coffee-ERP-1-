...
const CONFIGS: Record<AlertVariant, AlertConfig> = {
  success: {
    ...
    darkColor: '#4ADE80', darkBg: 'rgba(34,197,94,0.08)', darkBorder: 'rgba(34,197,94,0.2)',
  },
  info: {
    icon: 'M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10zM12 16v-4M12 8h.01',
    color: '#1D4ED8', bg: '#EFF6FF', border: '#BFDBFE',
    darkColor: '#93C5FD', darkBg: 'rgba(96,165,250,0.08)', darkBorder: 'rgba(96,165,250,0.2)',
  },
  warning: {
    icon: 'M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0zM12 9v4M12 17h.01',
    color: '#92400E', bg: '#FFFBEB', border: '#FDE68A',
    darkColor: '#FCD34D', darkBg: 'rgba(251,191,36,0.08)', darkBorder: 'rgba(251,191,36,0.2)',
  },
  danger: {
    icon: 'M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0zM12 9v4M12 17h.01',
    color: '#991B1B', bg: '#FFF5F5', border: '#FECACA',
    darkColor: '#FCA5A5', darkBg: 'rgba(248,113,113,0.08)', darkBorder: 'rgba(248,113,113,0.2)',
  },
}
