          ...
          {!loading && items.length > 0 && (
            <span
              style={{
                ...
                borderRadius: 10,
                padding: "0 5px",
                background: items.some((i) => i.severity === "danger")
                  ? "#DC2626"
                  : "#D97706",
                color: "#fff",
                fontSize: 10.5,
          ...
          {[...Array(3)].map((_, i) => (
            <div key={i} style={{ display: "flex", gap: 10 }}>
              ...
              <div style={{ flex: 1 }}>
                ...
                <div
                  className="skeleton-shimmer"
                  style={{ height: 11, width: "50%", borderRadius: 5 }}
                />
              </div>
            </div>
          ))}
