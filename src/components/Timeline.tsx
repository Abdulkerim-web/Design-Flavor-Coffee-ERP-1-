...
const STATUS_CONFIG: Record<TimelineStatus, {
  ...
  neutral: {
    ...
    darkBg: "var(--surface-02)",
    darkColor: "var(--text-muted)",
  },
}
          ...
          <div key={i} style={{ display: "flex", gap: 12, paddingBottom: 20 }}>
            ...
            >
              ...
              {i < 3 && (
                <div
                  className="skeleton-shimmer"
                  style={{ width: 2, flex: 1, marginTop: 6, borderRadius: 1 }}
                />
              )}
            </div>
            <div style={{ flex: 1, paddingTop: 4, paddingBottom: 16 }}>
              ...
              <div
                className="skeleton-shimmer"
                style={{ height: 11, width: "40%", borderRadius: 5 }}
              />
            </div>
          </div>
        ))}
      ...
      {items.map((item, idx) => {
        ...
        return (
          <div key={item.id} style={{ display: "flex", gap: 12 }}>
            ...
            >
              <div
                style={{
                  ...
                  outline: item.flagged
                    ? `2px solid ${isDark ? "#FCA5A5" : "#DC2626"}`
                    : undefined,
                  outlineOffset: 1,
                  zIndex: 1,
                }}
            ...
            {/* Right: content */}
            <div
              style={{ flex: 1, paddingBottom: isLast ? 0 : 20, paddingTop: 3 }}
            >
              <div
                style={{
                  display: "flex",
              ...
              >
                ...
                {item.actor && (
                  <span
                    style={{ fontSize: 10, color: "var(--border-neutral)" }}
                  >
                    ·
                  </span>
                )}
