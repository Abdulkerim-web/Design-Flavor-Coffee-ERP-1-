  ...
  <div style={{ display: "flex", flexDirection: "column", gap: 5, ...style }}>
    ...
    >
      ...
      {required && (
        <span
          aria-label="required"
          style={{ color: "var(--sem-danger)", fontSize: 13, lineHeight: 1 }}
        >
          *
        </span>
      )}
...
interface NumberInputProps
  extends Omit<InputHTMLAttributes<HTMLInputElement>, "onChange" | "type"> { // e.g. "KG", "%", "ETB"
  unit?: string
  error?: string
  onChange?: (value: string) => void
}
      ...
      <input
        ...
        onFocus={(e) => {
          ...
          e.currentTarget.style.boxShadow = `0 0 0 3px ${
            error ? "rgba(220,38,38,0.08)" : "rgba(43,77,58,0.08)"
          }`
        }}
        onBlur={(e) => {
          e.currentTarget.style.borderColor = borderColor
    ...
    <div style={{ position: "relative", flexShrink: 0, marginTop: 2 }}>
      ...
      <div
        style={{
          ...
          background: checked ? "var(--brand-primary)" : "var(--surface-01)",
          display: "flex",
          alignItems: "center",
