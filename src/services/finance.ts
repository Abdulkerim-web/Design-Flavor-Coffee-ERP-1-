...
export async function processPayment(orderId: string, amount: number, method: PaymentMethod, ref: string) {
  return apiRequest('/finance/payments', 'POST', { orderId, amount, method, ref });
}
