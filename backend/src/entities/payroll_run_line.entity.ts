...
export class PayrollRunLine {
  ...
  @ManyToOne(() => PayrollRun, (run) => run.lines)
  ...
  @Column({ name: 'base_salary_amount', type: 'decimal', precision: 14, scale: 2 })
  baseSalaryAmount: number;

  @Column({ name: 'advance_deduction_amount', type: 'decimal', precision: 14, scale: 2, default: 0 })
